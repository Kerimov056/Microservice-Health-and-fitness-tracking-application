...
public class TokenHandler : ITokenHandler
{
    ...
    public async Task<TokenResponseDTo> CreateAccesToken(int minutes, int refreshTokenMinustes, AppUser appUser)
    {
        ...
        return new TokenResponseDTo(token, ExpireDate, DateTime.UtcNow
            .AddMinutes(refreshTokenMinustes), refleshToken, appUser.UserName, appUser.Email, appUser.Id);
    }
