...
public class AppDbContextInitializer
{
    ...
    public async Task UserSeedAsync()
    {
        ...
        await _userManager.CreateAsync(superAdmin, _configuration["SuperAdminSettings:password"]);
        await _userManager.AddToRoleAsync(superAdmin, Role.SuperAdmin.ToString());
    }
}
